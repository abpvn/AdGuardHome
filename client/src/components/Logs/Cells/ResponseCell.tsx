...
import { getRulesToFilterList, formatElapsedMs, getFilterNames, getServiceName, clientsFiltersByClient } from '../../../helpers/helpers';
...
const ResponseCell = ({
    ...
    const clientsFilters = useSelector(
        (state: RootState) => clientsFiltersByClient(clientName, state.filtering.clientsFilters),
        shallowEqual,
    );
