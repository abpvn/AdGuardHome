...
const AutoClients = (props: AutoClientsProps) => {
    ...
    const columns = [
        ...
        },
        {
            ...
            accessor: (row: any) => props.normalizedTopClients.auto[row.ip] || 0,
    ...
    const { autoClients } = props;

    return (
        <Card title={t('auto_clients_title')} subtitle={t('auto_clients_desc')} bodyType="card-body box-body--settings">
            <ReactTable
                data={autoClients || []}
                columns={columns}
                defaultSorted={[
