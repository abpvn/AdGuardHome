...
const getTabs = ({ tlsAddress, httpsAddress, showDnsPrivacyNotice, serverNames, portHttps, t }: any) => ({
    Router: {
...
export const Guide = ({ dnsAddresses }: GuideProps) => {
    ...
    const serverNames = useSelector((state: RootState) => state.encryption?.server_names);
