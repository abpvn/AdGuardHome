 ...
 * @returns
 */
export const clientsFiltersByClient = (clientName, clientsFilters: ClientFilter[]) => {
    if (!clientName) {
...
export const normalizeFilters = (filters: any) =>
    filters
        ? filters.map((filter: any) => {
              const { id, url, enabled, last_updated, name = 'Default name', rules_count = 0, names } = filter;
