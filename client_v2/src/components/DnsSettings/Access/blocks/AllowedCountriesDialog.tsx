...
export const AllowedCountriesDialog = (props: Props) => {
    const field = useField<string>(
        () => props.open(),
        () => accessState.allowed_countries,
    );
    ...
    return (
        <ConfigDialog
            ...
            description={<p>{intl.getMessage('dns_allowed_countries_desc')}</p>}
            onClose={props.onClose}
            onSubmit={() => {
                field.submitIfValid((v) => {
                    setAccessList({ allowed_countries: v });
        ...
        >
            <div class={theme.form.input}>
                <Textarea
                    ...
                    label={intl.getMessage('dns_allowed_countries_label')}
